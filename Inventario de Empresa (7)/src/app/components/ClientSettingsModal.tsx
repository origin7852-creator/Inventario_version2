      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
        ...
        <div className="p-6">
          <p className="text-sm text-[#6b7280] mb-6">
            Gestiona la importación y exportación de clientes en formato Excel
          </p>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="font-medium text-[#111827]">Exportar Clientes</h3>
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="font-medium text-[#111827]">Importar Clientes</h3>
                <p className="text-sm text-[#6b7280]">
                  Carga clientes desde un archivo Excel
                </p>
              </div>
            </button>
