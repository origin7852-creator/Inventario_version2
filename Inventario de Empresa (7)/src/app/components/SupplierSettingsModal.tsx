      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
        ...
        <div className="p-6">
          <p className="text-sm text-[#6b7280] mb-4">
            Gestiona la importación y exportación de proveedores en formato Excel
          </p>

          {/* Nota informativa */}
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-6">
            <p className="text-sm text-blue-800">
              ℹ️ Los proveedores son compartidos entre el sistema de inventario normal y el sistema de contabilidad.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="font-medium text-[#111827]">Exportar Proveedores</h3>
                <p className="text-sm text-[#6b7280]">
                  Descarga todos los proveedores en formato Excel
                </p>
              </div>
            </button>
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="font-medium text-[#111827]">Importar Proveedores</h3>
                <p className="text-sm text-[#6b7280]">
                  Carga proveedores desde un archivo Excel
                </p>
              </div>
            </button>
